...
const senderKeys: KeyInfo = {
  address: "Replace_with_Sender_Address",
  publicKey: "Replace_with_Sender_public_key",
  privateKey: "Replace_with_Sender_Private_Key",
};
...
switch (step) {
  ...
  case 6:
    ...
    break;
  case 7:
    console.log("Running Step 7 Code");
    sendAsset();
    break;
  default:
    console.log("Please change the step variable to either 4,6,7!");
}
// =========================================================
